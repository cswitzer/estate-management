...
class ProfileSerializer(serializers.ModelSerializer):
    # ReadOnly fields will be ignored when updating the model, so these fields are ignored in request.post
    ...
    class Meta:
        model = Profile
        # These are the fields that can be viewed
        fields = [
            "id",
            "slug",
            "first_name",
    ...
    # connects to avatar SerializerMethodField above
